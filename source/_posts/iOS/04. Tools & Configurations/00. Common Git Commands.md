...
{% img /assets/iOS/Tools&Configurations/03_gitlog.png %}   
...
{% img /assets/iOS/Tools&Configurations/04_gitshortlog.png %}   
...
{% img /assets/iOS/Tools&Configurations/05_gitshow.png %} 
